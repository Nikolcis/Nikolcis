 ...
 * Python (in progress): Pandas, NumPy, Matplotlib, Jupyter
 * SQL: complex queries, joins, aggregations, data modeling basics
 ...
 * HTML5 / CSS3
 * Bootstrap
 * WordPress (themes, customizations, site management)

## 🌱 Currently learning

* Python for data analysis
* SQL for data engineering and database management
* Power BI and dashboard creation
* Fundamentals of ETL/ELT processes and cloud-based data workflows
* Business analytics foundations: KPIs, reporting, business insights
